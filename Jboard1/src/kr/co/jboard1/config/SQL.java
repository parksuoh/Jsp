...
public class SQL {
	...
	public final static String UPDATE_FILE_DOWN_COUNT = "UPDATE `JBOARD_FILE` SET `download`=`download`+ WHERE seq=? ";
	...
	public final static String UPDATE_COMMENT_COUNT2 = "UPDATE `JBOARD_ARTICLE` SET `comment` = `comment` - 1 " 
														+ "WHERE `seq`=?";
